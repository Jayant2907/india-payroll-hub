...
const navItems: NavItem[] = [
  ...
  { title: 'My Incentives', href: '/my-incentives', icon: Trophy, roles: ['employee'] },
  { title: 'Proof Verification', href: '/payroll/verification', icon: FileCheck, roles: ['admin', 'accountant'] },
  { title: 'Tax Optimizer', href: '/payroll/optimizer', icon: TrendingUp, roles: ['admin', 'accountant', 'employee'] },
